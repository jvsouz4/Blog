                        ...
                        <div class="row row-cols-lg-auto g-1 align-items-center mb-3">
                            <div class="col-12">
                                <div class="input-group">
                                    <input placeholder="Nome ou usuário" class="form-control" type="text" name="title" value="<?php echo $this->Session->read('title'); if(isset($_POST['$title'])){ echo $_POST['$title'];}?>">
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="input-group">
